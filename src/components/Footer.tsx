      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="mb-12">
          <svg className="w-full h-12 opacity-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80">
            <path
              fill="hsl(193, 100%, 42%)"
              d="M0,32L48,37.3C96,43,192,53,288,56C384,59,480,53,576,48C672,43,768,37,864,37.3C960,37,1056,43,1152,45.3C1248,48,1344,48,1392,48L1440,48L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
            />
          </svg>
        </div>
